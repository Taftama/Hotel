    ...
    <div class="container">
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="w3-content w3-section">
            <div><img class="mySlides" src="images/home_gallary/1.jpg" style="width:100%; height:450px;"></div>
            <div><img class="mySlides" src="images/home_gallary/2.jpg" style="width:100%; height:450px;"></div>
            <div><img class="mySlides" src="images/home_gallary/3.jpg" style="width:100%; height:450px;"></div>
            <div><img class="mySlides" src="images/home_gallary/4.jpg" style="width:100%; height:450px;"></div>
            <div><img class="mySlides" src="images/home_gallary/5.jpg" style="width:100%; height:450px;"></div>
            <div><img class="mySlides" src="images/home_gallary/6.jpg" style="width:100%; height:450px;"></div>
        </div>    
        </div>
        <hr>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              <h4><strong>Contact Us</strong></h4><hr>
                ...
                Abdullah Usama<br>
              Email:<br> 
              maliknoumanmaqbool@gmail.com <br>
              abdullahparacha786@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                <a href="#">Nouman Maqbool</a><br>
                <a href="#">Abdullah Usama</a><br>
            </div>
        </div>
    </div>
